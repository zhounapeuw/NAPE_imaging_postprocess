...
def zscore_(data, baseline_samples, baseline_data_input=None):
...
def extract_trial_data(data, tvec, start_end_samp, frame_events, conditions, specific_baseline=False, baseline_start_end_samp=None, save_dir=None):
    """
